...
Projectdata <- read_csv("/Users/patrick/Documents/Universität/Master/DSBA/Year_2/T1/Forecasting & Predictive Analytics/Project/Project and data-20220107/Projectdata.csv")
...
# Exponential Smoothing Model (ESX)


Hobbies_CA_1_all = Projectdata[, c('date', 'Hobbies_CA_1')]
Hobbies_CA_1_train = df_train[, c('date', 'Hobbies_CA_1')]
Hobbies_CA_1_test = df_train[, c('date', 'Hobbies_CA_1')]

# ts objects ------------------------------------------------------------

Hobbies_CA_1_all$date = as.Date(Hobbies_CA_1_all$date)
Hobbies_CA_1_all_ts <- ts(Hobbies_CA_1_all[,2],start=c(2011,01,29), frequency = 365)

Hobbies_CA_1_train$date = as.Date(Hobbies_CA_1_train$date)
Hobbies_CA_1_train_ts <- ts(Hobbies_CA_1_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Hobbies_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Hobbies_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Hobbies_CA_2_all = Projectdata[, c('date', 'Hobbies_CA_2')]
Hobbies_CA_2_train = df_train[, c('date', 'Hobbies_CA_2')]
Hobbies_CA_2_test = df_train[, c('date', 'Hobbies_CA_2')]

# ts objects ------------------------------------------------------------

Hobbies_CA_2_all$date = as.Date(Hobbies_CA_2_all$date)
Hobbies_CA_2_all_ts <- ts(Hobbies_CA_2_all[,2],start=c(2011,01,29), frequency = 365)

Hobbies_CA_2_train$date = as.Date(Hobbies_CA_2_train$date)
Hobbies_CA_2_train_ts <- ts(Hobbies_CA_2_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Hobbies_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Hobbies_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Hobbies_CA_3_all = Projectdata[, c('date', 'Hobbies_CA_3')]
Hobbies_CA_3_train = df_train[, c('date', 'Hobbies_CA_3')]
Hobbies_CA_3_test = df_train[, c('date', 'Hobbies_CA_3')]

# ts objects ------------------------------------------------------------

Hobbies_CA_3_all$date = as.Date(Hobbies_CA_3_all$date)
Hobbies_CA_3_all_ts <- ts(Hobbies_CA_3_all[,2],start=c(2011,01,29), frequency = 365)

Hobbies_CA_3_train$date = as.Date(Hobbies_CA_3_train$date)
Hobbies_CA_3_train_ts <- ts(Hobbies_CA_3_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Hobbies_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Hobbies_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_1_CA_1_all = Projectdata[, c('date', 'Foods_1_CA_1')]
Foods_1_CA_1_train = df_train[, c('date', 'Foods_1_CA_1')]
Foods_1_CA_1_test = df_train[, c('date', 'Foods_1_CA_1')]

# ts objects ------------------------------------------------------------

Foods_1_CA_1_all$date = as.Date(Foods_1_CA_1_all$date)
Foods_1_CA_1_all_ts <- ts(Foods_1_CA_1_all[,2],start=c(2011,01,29), frequency = 365)

Foods_1_CA_1_train$date = as.Date(Foods_1_CA_1_train$date)
Foods_1_CA_1_train_ts <- ts(Foods_1_CA_1_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_1_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_1_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_1_CA_2_all = Projectdata[, c('date', 'Foods_1_CA_2')]
Foods_1_CA_2_train = df_train[, c('date', 'Foods_1_CA_2')]
Foods_1_CA_2_test = df_train[, c('date', 'Foods_1_CA_2')]

# ts objects ------------------------------------------------------------

Foods_1_CA_2_all$date = as.Date(Foods_1_CA_2_all$date)
Foods_1_CA_2_all_ts <- ts(Foods_1_CA_2_all[,2],start=c(2011,01,29), frequency = 365)

Foods_1_CA_2_train$date = as.Date(Foods_1_CA_2_train$date)
Foods_1_CA_2_train_ts <- ts(Foods_1_CA_2_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_1_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_1_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_1_CA_3_all = Projectdata[, c('date', 'Foods_1_CA_3')]
Foods_1_CA_3_train = df_train[, c('date', 'Foods_1_CA_3')]
Foods_1_CA_3_test = df_train[, c('date', 'Foods_1_CA_3')]

# ts objects ------------------------------------------------------------

Foods_1_CA_3_all$date = as.Date(Foods_1_CA_3_all$date)
Foods_1_CA_3_all_ts <- ts(Foods_1_CA_3_all[,2],start=c(2011,01,29), frequency = 365)

Foods_1_CA_3_train$date = as.Date(Foods_1_CA_3_train$date)
Foods_1_CA_3_train_ts <- ts(Foods_1_CA_3_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_1_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_1_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_2_CA_1_all = Projectdata[, c('date', 'Foods_2_CA_1')]
Foods_2_CA_1_train = df_train[, c('date', 'Foods_2_CA_1')]
Foods_2_CA_1_test = df_train[, c('date', 'Foods_2_CA_1')]

# ts objects ------------------------------------------------------------

Foods_2_CA_1_all$date = as.Date(Foods_2_CA_1_all$date)
Foods_2_CA_1_all_ts <- ts(Foods_2_CA_1_all[,2],start=c(2011,01,29), frequency = 365)

Foods_2_CA_1_train$date = as.Date(Foods_2_CA_1_train$date)
Foods_2_CA_1_train_ts <- ts(Foods_2_CA_1_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_2_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_2_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_2_CA_2_all = Projectdata[, c('date', 'Foods_2_CA_2')]
Foods_2_CA_2_train = df_train[, c('date', 'Foods_2_CA_2')]
Foods_2_CA_2_test = df_train[, c('date', 'Foods_2_CA_2')]

# ts objects ------------------------------------------------------------

Foods_2_CA_2_all$date = as.Date(Foods_2_CA_2_all$date)
Foods_2_CA_2_all_ts <- ts(Foods_2_CA_2_all[,2],start=c(2011,01,29), frequency = 365)

Foods_2_CA_2_train$date = as.Date(Foods_2_CA_2_train$date)
Foods_2_CA_2_train_ts <- ts(Foods_2_CA_2_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_2_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_2_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_2_CA_3_all = Projectdata[, c('date', 'Foods_2_CA_3')]
Foods_2_CA_3_train = df_train[, c('date', 'Foods_2_CA_3')]
Foods_2_CA_3_test = df_train[, c('date', 'Foods_2_CA_3')]

# ts objects ------------------------------------------------------------

Foods_2_CA_3_all$date = as.Date(Foods_2_CA_3_all$date)
Foods_2_CA_3_all_ts <- ts(Foods_2_CA_3_all[,2],start=c(2011,01,29), frequency = 365)

Foods_2_CA_3_train$date = as.Date(Foods_2_CA_3_train$date)
Foods_2_CA_3_train_ts <- ts(Foods_2_CA_3_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_2_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_2_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_3_CA_1_all = Projectdata[, c('date', 'Foods_3_CA_1')]
Foods_3_CA_1_train = df_train[, c('date', 'Foods_3_CA_1')]
Foods_3_CA_1_test = df_train[, c('date', 'Foods_3_CA_1')]

# ts objects ------------------------------------------------------------

Foods_3_CA_1_all$date = as.Date(Foods_3_CA_1_all$date)
Foods_3_CA_1_all_ts <- ts(Foods_3_CA_1_all[,2],start=c(2011,01,29), frequency = 365)

Foods_3_CA_1_train$date = as.Date(Foods_3_CA_1_train$date)
Foods_3_CA_1_train_ts <- ts(Foods_3_CA_1_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_3_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_3_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_3_CA_2_all = Projectdata[, c('date', 'Foods_3_CA_2')]
Foods_3_CA_2_train = df_train[, c('date', 'Foods_3_CA_2')]
Foods_3_CA_2_test = df_train[, c('date', 'Foods_3_CA_2')]

# ts objects ------------------------------------------------------------

Foods_3_CA_2_all$date = as.Date(Foods_3_CA_2_all$date)
Foods_3_CA_2_all_ts <- ts(Foods_3_CA_2_all[,2],start=c(2011,01,29), frequency = 365)

Foods_3_CA_2_train$date = as.Date(Foods_3_CA_2_train$date)
Foods_3_CA_2_train_ts <- ts(Foods_3_CA_2_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_3_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_3_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Foods_3_CA_3_all = Projectdata[, c('date', 'Foods_3_CA_3')]
Foods_3_CA_3_train = df_train[, c('date', 'Foods_3_CA_3')]
Foods_3_CA_3_test = df_train[, c('date', 'Foods_3_CA_3')]

# ts objects ------------------------------------------------------------

Foods_3_CA_3_all$date = as.Date(Foods_3_CA_3_all$date)
Foods_3_CA_3_all_ts <- ts(Foods_3_CA_3_all[,2],start=c(2011,01,29), frequency = 365)

Foods_3_CA_3_train$date = as.Date(Foods_3_CA_3_train$date)
Foods_3_CA_3_train_ts <- ts(Foods_3_CA_3_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Foods_3_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Foods_3_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Household_1_CA_1_all = Projectdata[, c('date', 'Household_1_CA_1')]
Household_1_CA_1_train = df_train[, c('date', 'Household_1_CA_1')]
Household_1_CA_1_test = df_train[, c('date', 'Household_1_CA_1')]

# ts objects ------------------------------------------------------------

Household_1_CA_1_all$date = as.Date(Household_1_CA_1_all$date)
Household_1_CA_1_all_ts <- ts(Household_1_CA_1_all[,2],start=c(2011,01,29), frequency = 365)

Household_1_CA_1_train$date = as.Date(Household_1_CA_1_train$date)
Household_1_CA_1_train_ts <- ts(Household_1_CA_1_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Household_1_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Household_1_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Household_1_CA_2_all = Projectdata[, c('date', 'Household_1_CA_2')]
Household_1_CA_2_train = df_train[, c('date', 'Household_1_CA_2')]
Household_1_CA_2_test = df_train[, c('date', 'Household_1_CA_2')]

# ts objects ------------------------------------------------------------

Household_1_CA_2_all$date = as.Date(Household_1_CA_2_all$date)
Household_1_CA_2_all_ts <- ts(Household_1_CA_2_all[,2],start=c(2011,01,29), frequency = 365)

Household_1_CA_2_train$date = as.Date(Household_1_CA_2_train$date)
Household_1_CA_2_train_ts <- ts(Household_1_CA_2_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Household_1_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Household_1_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Household_1_CA_3_all = Projectdata[, c('date', 'Household_1_CA_3')]
Household_1_CA_3_train = df_train[, c('date', 'Household_1_CA_3')]
Household_1_CA_3_test = df_train[, c('date', 'Household_1_CA_3')]

# ts objects ------------------------------------------------------------

Household_1_CA_3_all$date = as.Date(Household_1_CA_3_all$date)
Household_1_CA_3_all_ts <- ts(Household_1_CA_3_all[,2],start=c(2011,01,29), frequency = 365)

Household_1_CA_3_train$date = as.Date(Household_1_CA_3_train$date)
Household_1_CA_3_train_ts <- ts(Household_1_CA_3_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Household_1_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Household_1_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Household_2_CA_1_all = Projectdata[, c('date', 'Household_2_CA_1')]
Household_2_CA_1_train = df_train[, c('date', 'Household_2_CA_1')]
Household_2_CA_1_test = df_train[, c('date', 'Household_2_CA_1')]

# ts objects ------------------------------------------------------------

Household_2_CA_1_all$date = as.Date(Household_2_CA_1_all$date)
Household_2_CA_1_all_ts <- ts(Household_2_CA_1_all[,2],start=c(2011,01,29), frequency = 365)

Household_2_CA_1_train$date = as.Date(Household_2_CA_1_train$date)
Household_2_CA_1_train_ts <- ts(Household_2_CA_1_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Household_2_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Household_2_CA_1_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Household_2_CA_2_all = Projectdata[, c('date', 'Household_2_CA_2')]
Household_2_CA_2_train = df_train[, c('date', 'Household_2_CA_2')]
Household_2_CA_2_test = df_train[, c('date', 'Household_2_CA_2')]

# ts objects ------------------------------------------------------------

Household_2_CA_2_all$date = as.Date(Household_2_CA_2_all$date)
Household_2_CA_2_all_ts <- ts(Household_2_CA_2_all[,2],start=c(2011,01,29), frequency = 365)

Household_2_CA_2_train$date = as.Date(Household_2_CA_2_train$date)
Household_2_CA_2_train_ts <- ts(Household_2_CA_2_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Household_2_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Household_2_CA_2_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
Household_2_CA_3_all = Projectdata[, c('date', 'Household_2_CA_3')]
Household_2_CA_3_train = df_train[, c('date', 'Household_2_CA_3')]
Household_2_CA_3_test = df_train[, c('date', 'Household_2_CA_3')]

# ts objects ------------------------------------------------------------

Household_2_CA_3_all$date = as.Date(Household_2_CA_3_all$date)
Household_2_CA_3_all_ts <- ts(Household_2_CA_3_all[,2],start=c(2011,01,29), frequency = 365)

Household_2_CA_3_train$date = as.Date(Household_2_CA_3_train$date)
Household_2_CA_3_train_ts <- ts(Household_2_CA_3_train[,2],start=c(2011,01,29), frequency = 365)

ex_variables = Projectdata[, ex_variables_n]
es(Household_2_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)
esx_model = es(Household_2_CA_3_all_ts, h=28, holdout=TRUE, interval=TRUE, silent=FALSE, xreg=ex_variables)$forecast
...
```{r}
# Definition of the Scaled Pinball Loss function
quantile_spl <- function(train_y, valid_y, quantile_preds, quantile){

    # train_y : All the demand used in the training set (vector)
    # valid_y : All true future value (vector)
    # quantile_preds: All Quantile value predicted at a given quantile
  
    loss = (((valid_y-quantile_preds)*(valid_y>=quantile_preds)*quantile) + 
              ((quantile_preds-valid_y)*(quantile_preds>valid_y)*(1-quantile)))
    sum_of_loss = sum(loss)
    div = sum_of_loss/length(quantile_preds)
    scale = mean(abs(diff(train_y)))
    spl = div/scale
    
    #print(paste("loss:", loss))
    #print(paste("sum_of_loss:", sum_of_loss))
    #print(paste("div:", div))
...
# Example
#x = c(11.5, 12, 11, 14, 10, 13, 11, 13, 14, 9, 15, 13)
#y = c(10 , 11, 10, 13.78, 9, 12, 10, 12, 13, 8, 14, 12)
#forecast = c(10, 12, 12.47, 13, 12, 11.69, 13, 14, 12, 10, 14, 13)
#quantile_spl(x,y,forecast, 0.9)
...
In the M5 competition the highest ranked submissions consisted solely of ML methods and vastly outperformed statistical benchmarks and their combinations. Due to advancements in data availability, efficiency of algorithms, preprocessing and computational power, ML methods provide more promising results as evidenced by the improved accuracy of the WRMSSE of over 20 % over all statistical benchmarks. Even with only smaller improvements for less aggregated time series, ML forecasting methods should be considered as today’s most promising approach to estimate the complex, non-linear relationships within the data. Next to gradient boosting methods like LightGBM can Deep Learning methods further optimize results and provide potential to outperform other ML algorithms. 
